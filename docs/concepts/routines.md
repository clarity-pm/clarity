...
**NOTE:** Currently, some of the routines related to the high level planning and review are not defined extensively since they relate more to how organizations execute planning at a high level than with Clarity framework itself. Apply your best judgment on how to manage these.

## Planning routines

Planning routines are routines during which upcoming work is planned, reviewed and organized. Planning meetings should result in -
...
The goal of this routine is to ensure all new tasks have a clear and defined [objective](tasks.md#task-objective), [implementation notes](tasks.md#implementation-notes), [checklist](tasks.md#task-checklist), [acceptance criteria](tasks.md#task-acceptance-criteria), and [estimation](tasks.md#task-estimation).
...
Also known as daily stand-up meeting. The main objectives of cycle review meetings are to present updates on the progress and discuss challenges associated with ongoing tasks. Cycle review meetings are done daily.

It is important to understand that this is a review meeting, not a planning meeting. Avoid in-depth discussions - report on current state of affairs, note any issues related to current work, and if necessary - schedule another meeting specific to issues identified during cycle review.
...
| Goal planning | When a goal is defined | Team  |
| Objective planning | When a objective is defined | Stakeholders, relevant Team leaders |
| New task review | As needed | Team leader, relevant Team members |
| Delivery cycle review | Every day | Team |
| Goal review | Every 1 to 2 delivery cycles | Team |
| Objective review | Every 2 to 4 delivery cycles | Stakeholders, relevant Team leaders |
| Task retrospective | Whenever a task is Delivered or Discarded | Task assignee |
| Delivery cycle retrospective | At the end of delivery cycle | Team |
| Postmortem | At the end of delivery cycle | Team |
| Goal retrospective | When a goal is complete - all relevant tasks delivered | Team |
| Objective retrospective | When a objective is delivered - all relevant goals delivered | Stakeholders, relevant Team leaders |
