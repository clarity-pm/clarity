...
Express tasks are your personal to-do items - all the agenda items you need to accomplish within a certain timeframe.

All tasks in your agenda should have at least a summary. A task summary should be short and as succinct as possible - but
with enough detail for you to identify and understand what the task is about without needing to look at the
...
In addition to a summary, tasks can also have a description. The description should contain all the extra details you
need to note about the task that do not fit in the summary. The description is optional.
...
It is perfectly fine to have one or more personal agendas provided you can allocate your time to each one of them. As
it often happens, you might keep personal and professional agendas separate from each other. You can also choose to
keep a single agenda for both - it is entirely up to you.

## Stages

All tasks in Express agenda should be categorized in five different sub-categories called stages - Today, Current Week,
Next Week, New and Later.

Each of these stages has special meaning and rules for what kind of tasks go in which stage.

### Today

The Today stage is designed to contain all the immediately upcoming tasks you need to accomplish within the
current day. This stage contains all the tasks you need to accomplish Today and no more. Tasks in this stage are
populated by taking tasks from the Current Week stage.

Tasks in Today stage should be clear and well defined - any tasks that are unclear and you cannot accomplish should
never be placed in Today. This will help you keep focused and eliminate uncertainty about what you need to accomplish.

You should try your best to avoid placing tasks directly into Today once the day has begun. You should treat your Today
stage as your personal daily commitment - any disruption to your commitment should be treated as an exception, not the
norm.

### Current Week

This stage should contain all the tasks you should be working on during the current week, but not Today. This stage serves
...
Week or Later. Tasks in this stage are generally sourced from either Next Week or New.

### Next Week

This stage is similar to Current Week, but contains all the tasks you should accomplish during Next Week. Tasks in
this stage are generally sourced from New or Later.

### New

This stage should contain all tasks recently added but not yet prioritized to be done during the Current Week, Next Week, or
Later. This stage serves as an intermediary for all the other stages.
...
All other tasks you might need to do in the future but without a fixed deadline within the next 2 weeks. This stage serves
as a kind of “everything else” box for your agenda.

## Prioritizing tasks

You should prioritize all tasks in the same order you need to do them - the tasks that need to be worked on sooner and have
...
time for them and make them part of your routine. This will help you keep your personal tasks in check.

### Daily review

Daily review is a routine you should perform at least once a day. During the Daily review you prepare all the tasks you
need to accomplish during Today. This is done by taking tasks from the top of the Current Week stage and moving them to
the Today stage.
...
into one of the other stages in the Agenda.
...
It is recommended to do a weekly review on the morning of the first day of the current week, but you can choose a
...
Nearly all personal task management apps can be used with the Express methodology. There is only one feature your task
management application should have to support Express: you should be able to create tasks organized in
compartmentalized lists. That is, you should be able to organize your task lists into custom categories or sublists -
Stages.

This is usually done by having several sublists added to the main task list or by using labels or similar
functionality.
...
boards [for Clarity](./faq.md#can-i-use-kanban-boards-to-illustrate-task-status-within-a-stage), **it is perfectly okay
